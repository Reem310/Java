	...
	<div class="container my-3">
		...
		<form action="omikuji/send" method="post">
			<div class="form-group mb-3">
				<label>Pick any number from 5 to 25</label><br> <select
					name="number">
			...
			<div class="form-group mb-3 col-md-5">
				<label>Enter professional endeacor or hobby:</label> <input
					type="text" class="form-control" name="hobby">
			</div>
			<div class="form-group mb-3 col-md-5">
				<label>Enter any type of living thing.</label> <input type="text"
					class="form-control" name="thing">
			</div>
			<div class="form-group mb-3 col-md-5">
				<label>Say something nice to someone:</label>
				<textarea name="comment" class="form-control" rows="3"
					placeholder="You do not realize how happy you make others."></textarea>
			</div>
